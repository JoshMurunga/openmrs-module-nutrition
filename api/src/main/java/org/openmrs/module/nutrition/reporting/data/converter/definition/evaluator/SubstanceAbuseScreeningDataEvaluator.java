...
/**
 * Evaluates a SubstanceAbuseScreeningDataDefinition
 */
@Handler(supports = SubstanceAbuseScreeningDataDefinition.class, order = 50)
public class SubstanceAbuseScreeningDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT e.`encounter_id`, \n"
                + "MAX(IF(o.concept_id=112603,IF(o.value_coded=1065, 'Yes', IF(o.value_coded=1066, 'No', IF(o.value_coded=1067, 'Unknown', IF(o.value_coded=1175, 'N/A', NULL)))),NULL)) AS substance_abuse_screening \n"
                + "FROM openmrs.obs o\n"
