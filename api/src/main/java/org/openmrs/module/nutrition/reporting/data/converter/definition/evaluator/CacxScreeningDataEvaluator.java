...
/**
 * Evaluates a CacxScreeningDataDefinition
 */
@Handler(supports = CacxScreeningDataDefinition.class, order = 50)
public class CacxScreeningDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT e.`encounter_id`, \n"
                + "MAX(IF(o.concept_id=164934,IF(o.value_coded=703, 'Positive', IF(o.value_coded=664, 'Negative', IF(o.value_coded=1118, 'Not Done', IF(o.value_coded=1175, 'N/A', NULL)))),NULL)) AS cacx_screening \n"
                + "FROM openmrs.obs o\n"
