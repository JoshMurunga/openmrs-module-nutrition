...
/**
 * Evaluates a NutritionalStatusDataDefinition
 */
@Handler(supports = NutritionalStatusDataDefinition.class, order = 50)
public class NutritionalStatusDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT e.`encounter_id`, \n"
                + "MAX(IF(o.concept_id=163300,IF(o.value_coded=1115, 'Normal', IF(o.value_coded=163302, 'Severe acute malnutrition', IF(o.value_coded=163303, 'Moderate acute malnutrition', IF(o.value_coded=114413, 'Overweight', NULL)))),NULL)) AS nutritional_status \n"
                + "FROM openmrs.obs o\n"
