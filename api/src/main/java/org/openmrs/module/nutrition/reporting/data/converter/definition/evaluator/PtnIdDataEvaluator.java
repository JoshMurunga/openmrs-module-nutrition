...
/**
 * Evaluates a PtnIdDataDefinition
 */
@Handler(supports = PtnIdDataDefinition.class, order = 50)
public class PtnIdDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT e.`encounter_id`, o.`person_id` patient_id \n"
                + "FROM openmrs.obs o\n"
