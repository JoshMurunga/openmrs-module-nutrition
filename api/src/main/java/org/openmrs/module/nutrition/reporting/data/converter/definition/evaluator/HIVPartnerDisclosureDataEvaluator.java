...
/**
 * Evaluates a HIVPartnerDisclosureDataDefinition
 */
@Handler(supports = HIVPartnerDisclosureDataDefinition.class, order = 50)
public class HIVPartnerDisclosureDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT e.`encounter_id`, \n"
                + "MAX(IF(o.concept_id=159423,IF(o.value_coded=1065, 'Yes', IF(o.value_coded=1066, 'No', IF(o.value_coded=1067, 'Unknown', IF(o.value_coded=1175, 'N/A', NULL)))),NULL)) AS hiv_partner_disclosure \n"
                + "FROM openmrs.obs o\n"
