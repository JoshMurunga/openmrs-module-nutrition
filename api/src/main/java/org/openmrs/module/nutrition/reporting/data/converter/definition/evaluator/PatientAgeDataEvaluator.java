...
/**
 * Evaluates a PatientAgeDataDefinition
 */
@Handler(supports = PatientAgeDataDefinition.class, order = 50)
public class PatientAgeDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT e.`encounter_id`, TIMESTAMPDIFF(YEAR,p.`birthdate`,NOW()) age \n"
                + "FROM openmrs.obs o\n"
