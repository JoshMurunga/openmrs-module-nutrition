...
/**
 * Evaluates a PartnerTestingDataDefinition
 */
@Handler(supports = PartnerTestingDataDefinition.class, order = 50)
public class PartnerTestingDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT e.`encounter_id`, \n"
                + "MAX(IF(o.concept_id=161557,IF(o.value_coded=1065, 'Yes', IF(o.value_coded=1066, 'No', IF(o.value_coded=1067, 'Unknown', IF(o.value_coded=1175, 'N/A', NULL)))),NULL)) AS partner_testing \n"
                + "FROM openmrs.obs o\n"
