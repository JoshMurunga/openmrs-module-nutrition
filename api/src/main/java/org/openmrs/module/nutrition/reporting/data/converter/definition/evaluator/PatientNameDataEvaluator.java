...
/**
 * Evaluates a PatientNameDataDefinition
 */
@Handler(supports = PatientNameDataDefinition.class, order = 50)
public class PatientNameDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT e.`encounter_id`, concat(family_name, ' ', given_name) \n"
                + "FROM openmrs.obs o\n"
