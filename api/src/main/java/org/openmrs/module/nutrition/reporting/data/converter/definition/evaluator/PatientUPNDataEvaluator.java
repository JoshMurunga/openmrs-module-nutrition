...
/**
 * Evaluates a PatientUPNDataDefinition
 */
@Handler(supports = PatientUPNDataDefinition.class, order = 50)
public class PatientUPNDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT e.`encounter_id`, upn.`identifier` \n"
                + "FROM openmrs.obs o\n"
                ...
                + "INNER JOIN openmrs.`patient_identifier` upn ON p.`person_id`=upn.`patient_id` and upn.`identifier_type`=6 \n"
