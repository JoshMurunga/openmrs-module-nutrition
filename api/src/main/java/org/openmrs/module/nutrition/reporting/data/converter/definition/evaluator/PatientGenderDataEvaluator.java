...
/**
 * Evaluates a PatientGenderDataDefinition
 */
@Handler(supports = PatientGenderDataDefinition.class, order = 50)
public class PatientGenderDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT e.`encounter_id`, p.`gender` \n"
                + "FROM openmrs.obs o\n"
